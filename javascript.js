...
// Hacker Console
setTimeout(() => {
  console.log("%cHuskDev Terminal v1.0", "color: #0f0; background:#000; font-size:16px;");
  console.log("%c> Connecting to dev tools...", "color: #aaa");
  setTimeout(() => {
    console.log("%c> Access granted. Welcome, Nazeem.", "color: #0f0");
  }, 1500);
}, 1000);
